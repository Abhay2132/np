...
(async function () {
	...
	function isValidName ( name ) {
		...
		$("#bn").addEventListener("keyup", function () {
			this.style.background = isValidName(this.value) ? "#fff" : "#C50E00";
			this.style.color = !isValidName(this.value) ? "#fff" : "#333";
			log(this.value)
		})
})();
